...
#define BCH_SB_ERRS()									\
	...
	x(need_discard_freespace_key_to_invalid_dev_bucket,	123,	FSCK_AUTOFIX)	\
	...
	x(inode_snapshot_mismatch,				196,	FSCK_AUTOFIX)	\
	...
	x(dup_backpointer_to_bad_csum_extent,			265,	FSCK_AUTOFIX)	\
	...
	x(data_update_got_non_extent,				350,	0)		\
